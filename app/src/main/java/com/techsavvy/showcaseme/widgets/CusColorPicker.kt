...
import com.techsavvy.showcaseme.ui.theme.MainColor
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.launch

@OptIn(ExperimentalStdlibApi::class)
@Composable
fun CusColorPicker(title: String, curColor: Color, onColorChange: (Color) -> Unit) {
    var isDialogueShow by remember { mutableStateOf(false) }
    Card(
        modifier = Modifier
            .clickable {
                isDialogueShow = !isDialogueShow
            }
            .padding(3.dp),
...
@OptIn(ExperimentalStdlibApi::class)
@Composable
fun CusColorPickerUtil(title: String, onDismiss: () -> Unit, onColorSelected: (Color) -> Unit) {
    Dialog(
        onDismissRequest = {
            onDismiss()
        },
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    "#" + backgroundColor.value.value.toHexString(HexFormat.UpperCase).dropLast(8),
